...
export const useToolkit = () => {
    ...
    const toolkitDefinitions = [
        ...
        { type: 'function', name: 'get_emails', description: "Retrieves recent emails from the user's Gmail inbox.", parameters: { type: 'object', properties: { maxResults: { type: 'number', default: 5 } } } },
        ...
        { type: 'function', name: 'summarize_emails', description: 'Summarizes recent emails from the inbox.', parameters: { type: 'object', properties: { maxResults: { type: 'number', default: 5 } } } },
